...
function getMovies(searchText){
  ...
  axios.get("https://api.themoviedb.org/3/search/movie?api_key=550dca91&language=en-US&query=" + searchText)
...
function getMovie(){
  ...
  /* Make a request for a user with a given ID */
  axios.get("https://api.themoviedb.org/3/movie/" + movieId + "?api_key=550dca91")
    .then(function (response) {
